...
The product shall have \sout{separate} \textcolor{blue}{designated} sections \textcolo{blue}{on the application screen to list} the user’s account authorizations, \textcolor{blue}{view / modify their present entries} and dedicate data entry to the creation of new user account usernames and passwords.\\
