...
\midrule
FR1 & \mref{mGUI}, \mref{\textcolor{blue}{mCons}}\\
FR2 & \mref{mDB}\\
FR3 & \mref{mPCUC}\\
FR4 & \mref{mPCUL}\\
...
FR9 & \mref{mCop}\\
FR10 & \mref{\sout{mPCUC}}, \mref{\textcolor{blue}{mPG}}, \mref{\textcolor{blue}{mPCUL}}, \mref{\textcolor{blue}{mDB}}\\
FR11 & \mref{mEH}, \mref{\textcolor{blue}{mDB}}\\
FR12 & \mref{\textcolor{blue}{mGUI}}, \mref{\textcolor{blue}{mDB}}\\
FR13 & \mref{\textcolor{blue}{mGUI}}, \mref{\textcolor{blue}{mDB}}\\
\bottomrule
\end{tabular}
